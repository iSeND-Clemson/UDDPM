...
# =======================================================
    ...
    # You can download full dataset, or use your own dataset, here is only an example
    # img_path = './wildfire_images/FLAME 2/254p Dataset/254p RGB Images/'
    # img_path = './wildfire_images/FLAME 1/Images/Images/'
...
# =======================================================
    ...
    opt.prompt = "wildfire in snow, flame and smoke, drone view, photo realistic, high resolution, 4k, HD"
    opt.n_samples = 1
    opt.n_iter = 1
    opt.skip_grid = True
    opt.watermark = False
    opt.outdir = f'./exp/outputs/{exp_name}/'
